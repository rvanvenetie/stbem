...
for k in range(10):
    ...
    cache_SL_fn = "{}/SL_coloc_dofs_{}_{}.npy".format('data', N, mesh.md5())
    try:
        ...
        for i, elem_test in enumerate(elems_cur):
            ...
            for j, elem_trial in enumerate(elems_cur):
                mat[i, j] = SL.evaluate(elem_trial, t, x_hat, x)
        try:
    ...
    cache_M0_fn = "{}/M0_coloc_dofs_{}_{}.npy".format('data', N, mesh.md5())
    try:
